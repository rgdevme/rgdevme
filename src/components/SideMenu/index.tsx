...
export const SideMenu = ({
	...
	return (
		<div className='cursor-default sm:fixed sm:max-w-md sm:max-h-screen overflow-overlay overflow-x-hidden bg-zinc-900 no-scrollbar static w-screen sm:w-[40vw]'>
